      ...
      <form class="form" action="" method="post" enctype="multipart/form-data" >
        ...
        <div id="optional" hidden>
          ...
          <div class="input-group">
            ...
            <select class="form-control" onchange="setValue('position')">
              <option value="stack">堆叠(stack)</option>
              <option value="dodge">并列(dodge)</option>
              <input type="hidden" name="position" value="stack" />
            </select>
          </div>
          <br>
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control" name="xlab" />
          </div>
          <br>
          
          <div class="input-group">
            <span class="input-group-addon">Y轴名称</span>
            <input type="text" class="form-control" name="ylab" />
          </div>
          <br>
      ...
      <div>
        ...
        <div class="tab-content">
          ...
          <div role="tabpanel" class="tab-pane" id="shili">
            ...
            <img src="code/test.txt.png">
            <p><a href="#" >输出结果</a></p>
            <img src="code/test.png" width="500px">
          </div>
        </div>
      </div>
    </div>
